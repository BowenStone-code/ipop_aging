...
dir.create("3-data_analysis/plasma_cytokine/data_preparation/same_samples",recursive = TRUE)
setwd("3-data_analysis/plasma_cytokine/data_preparation/same_samples")
